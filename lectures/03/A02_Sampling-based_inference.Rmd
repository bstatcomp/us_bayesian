...
$$\frac{1}{m} \sum_{i = 1}^m X^{(i)} \sim  N(E[X], Var[X] / \sqrt{m}), \text{ ko } m \rightarrow \infty.$$
...
xi <- c(0.5)
for (i in 2:(m+1)) {
  xc <- xi[i-1] + runif(1, -0.3, 0.3)   # candidate for next x is uniformly distributed around current x
